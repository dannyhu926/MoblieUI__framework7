var flyZommImg = function (b, a) {
    ...
    this._opts = {
        ...
        if (this.group_names.length > 0 && this.opts.miscellaneous) {
            ...
            e += "<span class='fly-zoom-box-zoom' style='background: rgba(255,255,255,0.2);border-radius: 15px;color: #fff;padding: 0px 6px'>＋</span>";
        }
        e += "</div>";
        $("body").append(e);
        this._showBox()
