(function(){
	...
	(mt.s.wa = function(){
		...
		document.addEventListener ? f = function(){
			document.removeEventListener("DOMContentLoaded", f, t);
			a()
		} : document.attachEvent && (f = function(){
			"complete" === document.readyState && (document.detachEvent("onreadystatechange", f), a())
		});
		(function(){
			if(!e)if(e = r, "complete" === document.readyState)a.A = r;
			else
				if(document.addEventListener)document.addEventListener("DOMContentLoaded", f, t), window.addEventListener("load", a, t);
				else
	...
	mt.event.c = function(a, b, e){
		a.attachEvent ? a.attachEvent("on"+b, function(b){
			e.call(a, b)
		}) : a.addEventListener && a.addEventListener(b, e, t)
	};
			...
			switch(typeof d){
				...
				default:
					...
					if(d instanceof Array){
						var f = ["["], e = d.length, p, g, k;
						for(g = 0; g < e; g++)switch(k = d[g], typeof k){
							case "undefined":
							case "function":
							case "unknown":
								break;
							default:
								p && f.push(","), f.push(mt.l.stringify(k)), p = 1
						}
						f.push("]");
						return f.join("")
					}
					...
					p = ["{"];
					g = mt.l.stringify;
					for(e in d)if(Object.prototype.hasOwnProperty.call(d, e))switch(k = d[e], typeof k){
						case "undefined":
						case "unknown":
						case "function":
							break;
						default:
							f && p.push(","), f = 1, p.push(g(e)+":"+g(k))
					}
					p.push("}");
					return p.join("")
			}
	...
	(function(){
		function a(a, d){
			...
			b.e(d, "Function") && (f.readyState ? f.onreadystatechange = function(){
				if("loaded" === f.readyState || "complete" === f.readyState)f.onreadystatechange = s, d()
			} : f.onload = function(){
				d()
			});
			f.src = a;
	...
	(function(){
		...
		function b(){
			...
			if((!p || !k) && g && l)u = r, n = +new Date;
			else
				if(p && k && (!g || !l))u = t, q += +new Date-n;
			p = g;
			k = l;
			x = setTimeout(b, 100)
		}
		...
		function e(a){
			...
			if(a in n)k = a;
				...
				var d = q[b]+a.charAt(0).toUpperCase()+a.slice(1);
				if(d in n){
					k = d;
					break
				}
		...
		var f = mt.event, m = h.F, p = r, g = r, k = r, l = r, v = +new Date, n = v, q = 0, u = r, w = e("visibilityState"), y = e("hidden"), x;
		b();
		(function(){
			...
			"object" == typeof document.onfocusin ? (f.c(document, "focusin", d), f.c(document, "focusout", d)) : (f.c(window, "focus", d), f.c(window, "blur", d))
		})();
		h.D = {
			ia:function(){
				return +new Date-v
			}, fa:function(){
				return u ? +new Date-n+q : q
			}
		};
		m.c("pv-b", function(){
			f.c(window, "unload", a())
	...
	(function(){
		var a = mt.lang, b = h.r, e = h.load, d = {
			sa:function(d){
	...
	(function(){
		...
		var e = mt.lang, d = mt.l, f = h.r, m = h.F, p = h.aa, g = {
			q:[], B:0, T:t, init:function(){
				g.d = 0;
				m.c("pv-b", function(){
					g.ba();
					g.ca()
				...
				if(!a || e.e(a, "Array"))window._hmt = {
					id:c.id, cmd:{}, push:function(){
						for(var a = window._hmt, k = 0; k < arguments.length; k++){
							var n = arguments[k];
							e.e(n, "Array") && (a.cmd[a.id].push(n), "_setAccount" === n[0] && (1 < n.length && /^[0-9a-f]{32}$/.test(n[1])) && (n = n[1], a.id = n, a.cmd[n] = a.cmd[n] || []))
						}
					}
				}, window._hmt.cmd[c.id] = [], window._hmt.push.apply(window._hmt, a)
			}, ca:function(){
				var a = window._hmt;
				if(a && a.cmd && a.cmd[c.id])for(var b = a.cmd[c.id], d = /^_track(Event|MobConv|Order|RTEvent)$/, n = 0, q = b.length; n < q; n++){
					var f = b[n];
					d.test(f[0]) ? g.q.push(f) : g.L(f)
				}
				a.cmd[c.id] = {push:g.L}
			}, da:function(){
				if(0 < g.q.length)for(var a = 0, b = g.q.length; a < b; a++)g.L(g.q[a]);
				g.q = s
			}, L:function(a){
				var b = a[0];
				...
				if(1 < a.length && a[1].charAt && "/" === a[1].charAt(0)){
					...
					g.T || (h.b.a.su = document.location.href);
					h.b.i();
					h.b.a.u = b;
					h.b.a.su = d
				}
			}, _trackEvent:function(a){
				2 < a.length && (g.d |= 8, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = b(a[1])+"*"+b(a[2])+(a[3] ? "*"+b(a[3]) : "")+(a[4] ? "*"+b(a[4]) : ""), h.b.i())
			}, _setCustomVar:function(a){
				if(!(4 > a.length)){
					var d = a[1], f = a[4] || 3;
					if(0 < d && 6 > d && 0 < f && 4 > f){
						g.B++;
						for(var n = (h.b.a.cv || "*").split("!"), q = n.length; q < d-1; q++)n.push("*");
						n[d-1] = f+"*"+b(a[2])+"*"+b(a[3]);
						h.b.a.cv = n.join("!");
				...
				1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? f.protocol+"//"+window.location.host+a[1] : a[1], g.T = r)
			}, _trackOrder:function(b){
				b = b[1];
				e.e(b, "Object") && (a(b), g.d |= 16, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 94, h.b.a.ep = d.stringify(b), h.b.i())
			}, _trackMobConv:function(a){
				if(a = {
						webim:1, tel:2, map:3, sms:4, callback:5, share:6
					}[a[1]])g.d |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.i()
			}, _trackRTPageview:function(b){
				b = b[1];
				e.e(b, "Object") && (a(b), b = d.stringify(b), 512 >= encodeURIComponent(b).length && (g.d |= 64, h.b.a.rt = b))
				...
				if(e.e(b, "Object")){
					...
					else for(var m = Math.ceil(m/900), n = "block|"+Math.round(Math.random()*f.K).toString(16)+"|"+m+"|", q = [], u = 0; u < m; u++)q.push(u), q.push(b.substring(900*u, 900*u+900)), l.call(this, n+q.join("|")), q = []
				}
	...
	(function(){
		...
		var b = mt.url, e = mt.N, d = mt.O, f = mt.lang, m = mt.cookie, p = mt.k, g = mt.localStorage, k = mt.sessionStorage, l = h.r, v = h.F;
		a.prototype = {
			J:function(a, b){
				a = "."+a.replace(/:\d+/, "");
				b = "."+b.replace(/:\d+/, "");
				...
				for(var q = 0; q < c.dm.length; q++)if(-1 < c.dm[q].indexOf("/")){
					if(this.U(a, c.dm[q]))return r
				}
				else{
					var d = b.Q(a);
					if(d && this.J(d, c.dm[q]))return r
				}
				return t
			}, H:function(){
				...
				try{
					m.set(a, b, {domain:this.H(), path:this.P(), G:d}), d ? g.set(a, b, d) : k.set(a, b)
				}catch(f){
				}
			}, xa:function(a){
				try{
					m.set(a, "", {domain:this.H(), path:this.P(), G:-1}), k.remove(a), g.remove(a)
				}catch(b){
				}
			}, Da:function(){
				var a, b, d, f, e;
				...
				if(d = this.getData("Hm_lvt_"+c.id)){
					...
					for(; 2592E3 < l.m-f[0];)f.shift();
					e = 4 > f.length ? 2 : 3;
					for(1 === a && f.push(l.m); 4 < f.length;)f.shift();
					d = f.join(",");
					f = f[f.length-1]
				}
				else d = l.m, f = "", e = 1;
				...
				for(var a = [], b = 0, d = l.W.length; b < d; b++){
					var f = l.W[b], e = this.a[f];
				...
				this.a.cm = b.j(a, l.pa) || "";
				this.a.cp = b.j(a, l.qa) || "";
				this.a.cw = b.j(a, l.oa) || "";
				this.a.ci = b.j(a, l.ma) || "";
				this.a.cf = b.j(a, l.ra) || "";
				this.a.cu = b.j(a, l.na) || ""
			}, init:function(){
				try{
					this.Ea(), 0 === this.a.nv ? this.Aa() : this.M(".*"), h.b = this, this.$(), v.w("pv-b"), this.za()
				}catch(a){
					var b = [];
					b.push("si="+c.id);
				...
				this.R ? (this.I = r, this.a.et = 0, this.a.ep = "", this.i(a)) : a()
			}, i:function(a){
				var b = this;
				b.a.rnd = Math.round(Math.random()*l.K);
				v.w("stag-b");
				var d = l.protocol+"//"+l.V+"?"+b.Ba();
				v.w("stag-d");
				b.X(d);
				e.log(d, function(d){
					b.M(d);
				...
				var a = document.location.hash.substring(1), d = RegExp(c.id), f = -1 < document.referrer.indexOf(l.Y), e = b.j(a, "jn"), g = /^heatlink$|^select$/.test(e);
				a && (d.test(a) && f && g) && (this.a.rnd = Math.round(Math.random()*l.K), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", l.protocol+"//"+c.js+e+".js?"+this.a.rnd), e = document.getElementsByTagName("script")[0], e.parentNode.insertBefore(a, e))
			}, X:function(a){
	...
	(function(){
		var a = mt.s, b = mt.event, e = mt.url, d = mt.l;
		try{
			if(window.performance && performance.timing && "undefined" !== typeof h.b){
				...
				var g = function(){
					...
					a = document.referrer;
					var q = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [], k = s;
					b = s;
					if("www.baidu.com" === q[2] || "m.baidu.com" === q[2])k = e.j(a, "qid"), b = e.j(a, "click_t");
					a = k;
					g.qid = a != s ? a : "";
					b != s ? (g.bdDom = p ? p-b : 0, g.bdRun = f-b, g.bdDef = m("navigation").start-b) : (g.bdDom = 0, g.bdRun = 0, g.bdDef = 0);
					h.b.a.et = 87;
	...
	(function(){
		var a = mt.lang, b = mt.event, e = mt.l;
		if(c.comm && "undefined" !== typeof h.b){
			var d = function(a){
				...
				return [].slice.call(a)
			}, f = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, m = {
				click:function(){
					for(var a = [], b = d(document.getElementsByTagName("a")), b = [].concat.apply(b, d(document.getElementsByTagName("area"))), b = [].concat.apply(b, d(document.getElementsByTagName("img"))), e = 0, g = b.length; e < g; e++){
						var m = b[e], k = m.getAttribute("onclick"), m = m.getAttribute("href");
						(f.test(k) || f.test(m)) && a.push(b[e])
					}
					return a
				}
			}, p = function(a, b){
				...
				g.v = b;
				if(d){
					var m = d.getAttribute("href"), k = d.getAttribute("onclick") ? ""+d.getAttribute("onclick") : s, l = d.getAttribute("id") || "";
				...
				if(k === d)return g(l+b, d), t;
				if(a.e(d, "Array") || a.e(d, "NodeList"))for(var f = 0, e = d.length; f < e; f++)if(k === d[f])return g(l+b+"/"+(f+1), d[f]), t
			};
			b.c(document, "click", function(b){
				b = b || window.event;
				k = b.target || b.srcElement;
				var d = {};
				for(p(m, function(b, f){
					d[b] = a.e(f, "Function") ? f() : document.getElementById(f)
				}); k && k !== document && p(d, v) !== t;)k = k.parentNode
			})
		}
	})();
	(function(){
		...
		if(c.comm && "undefined" !== typeof h.b){
			var e = +new Date, d = {n:"anti", sb:0, kb:0, clk:0}, f = function(){
				h.b.a.et = 86;
	...
	(function(){
		...
		a.prototype = {
			ta:function(a){
				if(this.f)this.h(a, 0);
					...
					if(this.isSupported()){
						try{
							this.f = new ActiveXObject("BDEXIE.BDExExtension.1"), this.S = r
						}catch(b){
							this.S = t
						}
						this.S ? this.h(a, 0) : this.h(a, -1)
					}
					else this.h(a, -1)
			}, Ga:function(){
				...
				var a = this;
				this.ea(function(d){
					void 0 !== d && "" !== d && (b.log("//datax.baidu.com/x.gif?dm="+encodeURIComponent("datax.baidu.com/webadapter/guid")+"&ac="+encodeURIComponent(d)+"&v=hm-webadapter-0.0.1&rnd="+Math.round(2147483647*Math.random())), a.Ca("hmKey", +new Date, function(){
						a.Ga()
					}))
				})
			}
		...
		if(e.ua && /^http(s)?:$/.test(document.location.protocol)){
			var d = new a;
			d.ta(function(a){
				0 === a && d.ha("hmKey", function(a){
					a = +a;
					(isNaN(a) || 6048E5 < +new Date-a) && d.va()
				})
			})
		}
	})();
